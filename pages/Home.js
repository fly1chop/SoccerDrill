...
import { Platform, View, Text, StyleSheet, Button, ScrollView, TouchableOpacity, ActivityIndicator, FlatList } from "react-native";
...
import { videoRecoil, randomVideoRecoil, showHomeRecoil, showSearchRecoil } from "../recoil/recoil";
...
export default function Home(props) {
    ...
    const [homeVideos, setHomeVideos] =  useRecoilState(showHomeRecoil);
    const [searchVideos, setSearchVideos] =  useRecoilState(showSearchRecoil);
